 ...
 */
abstract public class SnapcastMethodServer extends JsonRpcNotificationHandler<ClientNotification> {
    private final SnapcastController controller;

    public SnapcastMethodServer(final String method, final SnapcastController controller) {
